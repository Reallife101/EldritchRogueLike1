...
public class mapGenerator : MonoBehaviour
{
    ...
    public static int ROOM_LENGTH = 75;
    ...
    private static (int, float)[] rotates =new (int, float)[] {(0,0f), (1, 0), (1, 90f), (1, 180f), (1, 270f), (5, 0f), (6, 0f), (5, 270f), 
        (5, 90f), (6, 90f), (5, 180f), (11, 0f), (11, 270f), (11,180f), (11, 90f), (15, 0f)};
    ...
    public void genMap()
    {
        // This is the list of rooms with 3 or more exits
        ...
        while (remaining_rooms.Count > 0)
        {
            ...
            // check for exit
            if (remaining_rooms.Count == 1)
            {
                exitLoc = ((int)point.x, (int)point.y);
            }
    ...
    public void buildmap(int[,] matrix)
    {
        ...
        for (int i = 0; i < matrix.GetLength(0); i++)
        {
            for (int j = 0; j < matrix.GetLength(1); j++)
            {
                float rotation = rotates[matrix[i, j]].Item2;
